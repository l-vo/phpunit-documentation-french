...
- ``processUncoveredFilesFromWhitelist="true"`` signifie qu'un fichier de la liste blanche qui n'a aucune ligne de code d'exécutée sera chargé par PHPUnit et pourra donc etre analysé pour l'information correcte des lignes de code excécutables
